...
function SpriteSheet (path, frameWidth, frameHeight, frameSpeed, endFrame, ctx) { // endframe start at 1
    this.img = new Image();
    
    // calc the number of frames ina row after the image loads
    this.img.onload = function() {
        this.framesPerRow = Math.floor(this.img.width / frameWidth);
    };
    ...
    this.currentFrame = 0; // current frame to draw
